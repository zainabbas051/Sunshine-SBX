({
    getAllData : function(component) {
        ...
        var action = component.get("c.getAllInfectionReports");
        ...
        action.setCallback(this, function (a) {
            ...
            if(state == 'SUCCESS'){
                ...
                resultData.forEach(function(record){
                    record.linkName = '/ccp/s/reportformreadonly?Id='+record.Id+'&reporttype=InfectionReport';
                });
    ...
    getSearchDate : function(component){
        debugger;
        var action = component.get("c.getSearchInfection");
        var pageSize = component.get("v.pageSize").toString();
        var pageNumber = component.get("v.pageNumber").toString();
    ...
    if(fieldName == 'Date_Symptoms_Identified__c'){ 
