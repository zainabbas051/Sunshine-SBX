({
    ...
    hideSpinner : function(component,event,helper){
     ...
     handleCreateLoad: function (component, event, helper) {
        ...
        var thumbnailUrl=  component.find("ThumbnailImageField").get("v.value");
         ...
         if(cmpContentType == 'Clinical Quotes'){
         var reslUrl=  component.find("ResourceField").get("v.value");
        component.set("v.VideoURL",reslUrl);
             var selectedTagLst = component.find("TagContentField").get("v.value");
           component.set("v.selectedTagList",selectedTagLst.split(';'));
         }
         debugger;
    ...
    doInit: function(component, event, helper) {
      ...
      // alert(component.get("v.selectedRowId"));
        var cmpContentType = component.get("v.DailyContentType");
        if (cmpContentType == 'Motivational Quotes') {
            component.set("v.type", 'Motivational Quotes');
        }
        if (cmpContentType == 'Success Stories') {
            component.set("v.type", 'Success Stories');
        }
