({
    defaultAction : function(component, event, helper) {
        ...
        component.set('v.YesNoOption',opts);
        var Typeopts = [
        ...
        component.set('v.TypeofInfectionOption',Typeopts);    
    ...
    TypeofInfectionChange : function(component,event,helper){
		debugger;
        component.set('v.TypeofInfectionOther',false);
        var changeValue = event.getParam("value");
        if(changeValue.indexOf('Other') > -1){
            component.set('v.TypeofInfectionOther',true);
        }
    ...
    navigate : function(component, event, helper) {
        var urlEvent = $A.get("e.force:navigateToURL");
         urlEvent.setParams({
           'url': '../apex/infectionControlReportPDF_HTML?id=' + component.get('v.RecordId')
         });
         urlEvent.fire();
       }
