({
    getAllData : function(component) {
        ...
        var action = component.get("c.getAllIncidents");
        ...
        action.setCallback(this, function (a) {
            ...
            if(state == 'SUCCESS'){
                ...
                resultData.forEach(function(record){
                    record.linkName = '/ccp/s/reportformreadonly?Id='+record.Id+'&reporttype=IncidentReport';
                });
    ...
    getSearchDate : function(component){
        debugger;
        var action = component.get("c.getSearchIncident");
        var pageSize = component.get("v.pageSize").toString();
        var pageNumber = component.get("v.pageNumber").toString();
    ...
    sortData : function(component,fieldName,sortDirection){
        ...
        if(fieldName == 'Date_Time_of_Incident__c'){ 
